...
class Space:
    ...
    def tf_search_point(self, point: tf.Tensor, k: tf.Tensor) -> Tuple[tf.Tensor, tf.Tensor]:
        raw_acts, acts = tf.numpy_function(self.search_point, [point, k], (tf.double, tf.int32))
        return raw_acts, acts
